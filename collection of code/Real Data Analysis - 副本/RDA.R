...
ipw_ET_without_cure(eta1, x, y, a, prob, delta, Gc_y)
# D-aipw-T: maxT
set.seed(2023)
...
ipw_ET_without_cure(eta2, x, y, a, prob, delta, Gc_y)
...
## penalty
set.seed(2023)
beta_3_38 <- solve_penalty_1(0.1, q_cons=38,x, y, a, prob, tao, delta, Gc_tao, Gc_y,t.es_0, t.es_1, p.es_0, p.es_1,
                             stp_sz = 0.01, tol = 1e-3, max_iter = 20000,range=c(-10,10),num_starts = 5)
beta_3_40 <- solve_penalty_1(100, q_cons=40,x, y, a, prob, tao, delta, Gc_tao, Gc_y,t.es_0, t.es_1, p.es_0, p.es_1,
...
beta_3_56 <- solve_penalty_1(0.1, q_cons=56,x, y, a, prob, tao, delta, Gc_tao, Gc_y,t.es_0, t.es_1, p.es_0, p.es_1,
                             stp_sz = 0.01, tol = 1e-3, max_iter = 20000,range=c(-10,10),num_starts = 5)
aipw_U_stoc(beta_3_40, x, y, a, prob, tao, delta, Gc_tao, p.es_0,p.es_1)
aipw_T_stoc(beta_3_40, x, y, a, prob, tao, delta, Gc_tao, Gc_y, t.es_0, t.es_1, p.es_0, p.es_1)

beta_3_57 <- solve_penalty_1(0.1, q_cons=57,x, y, a, prob, tao, delta, Gc_tao, Gc_y,t.es_0, t.es_1, p.es_0, p.es_1,
                             stp_sz = 0.01, tol = 1e-3, max_iter = 20000,range=c(-10,10),num_starts = 5)
aipw_U_stoc(beta_3_38, x, y, a, prob, tao, delta, Gc_tao, p.es_0,p.es_1)
aipw_T_stoc(beta_3_38, x, y, a, prob, tao, delta, Gc_tao, Gc_y, t.es_0, t.es_1, p.es_0, p.es_1)
...
beta_3_52 <- solve_penalty_1(0.5, q_cons=52,x, y, a, prob, tao, delta, Gc_tao, Gc_y,t.es_0, t.es_1, p.es_0, p.es_1,
                             stp_sz = 0.01, tol = 1e-3, max_iter = 20000,range=c(-10,10),num_starts = 1)
aipw_U_stoc(c(1,1,1,2), x, y, a, prob, tao, delta, Gc_tao, p.es_0,p.es_1)
